...
function Container() {
    const [songData, setSongData] = useState([
        ...
        {id: 2, title: "Bad Guy", artist: "Billie Eilish", genre: "pop", rating: 4 },
        {id: 3, title: "Lonely Boy", artist: "Black Keys", genre: "rock", rating: 5 }
    ])

    const addSong = (title, artist, genre, rating) => {
        setSongData(prevState => [...prevState, 
            {
    ...
    const onSortRating = () => {
        const sortRatingSongData = [...songData].sort((a, b ) =>
            b.rating - a.rating
        )
